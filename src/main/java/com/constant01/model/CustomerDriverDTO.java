...
public class CustomerDriverDTO {
	...
	public String toString() {
		return "CustomerDriverDTO [m_userId=" + m_userId + ", m_userPw=" + m_userPw + ", m_name=" + m_name
				+ ", m_phone=" + m_phone + ", driverLat=" + driverLat + ", driverLon=" + driverLon + ", order_no="
				+ order_no + ", m_email=" + m_email + ", p_no=" + p_no + ", productname=" + productname
				+ ", productcode=" + productcode + ", order_date=" + order_date + ", order_quantity=" + order_quantity
				+ ", refund_chk=" + refund_chk + ", total_price=" + total_price + ", status=" + status + ", ju_name="
				+ ju_name + ", ju_tel=" + ju_tel + ", ju_zipCd=" + ju_zipCd + ", ju_addr=" + ju_addr
				+ ", ju_addr_detail=" + ju_addr_detail + ", su_name=" + su_name + ", su_zipCd=" + su_zipCd + ", su_tel="
				+ su_tel + ", su_addr=" + su_addr + ", su_addr_detail=" + su_addr_detail + ", m_userStat=" + m_userStat
				+ ", m_driver=" + m_driver + ", su_pass=" + su_pass + ", su_deliv=" + su_deliv + ", su_memo=" + su_memo
				+ ", p_sal=" + p_sal + ", p_name=" + p_name + ", coupon_use=" + coupon_use + "]";
	}
