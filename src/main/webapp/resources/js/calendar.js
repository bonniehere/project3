...
function calendar_set(e)
{
    ...
    calendar_div.style.cssText = "width:200px; padding:12px; background-color:#ffffff; border:1px solid #656c74; border-radius:12px; box-shadow:1px 12px 7px rgba(0,0,0,.2); box-sizing:border-box;z-index:999;";
