...
#over{
	...
	<script type="text/javascript">
		...
		function joinform_check() {
			...
			var ag2 = document.getElementById("ag2");
			var ag3 = document.getElementById("ag3");
...
<body>
<form name="join_form" action="joinForm3.do" method="post">
...
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" name="chk" id="ag1">
  <label class="form-check-label" for="flexCheckChecked">
    이용약관 동의 <span id="err">(필수)</span>
  </label>
</div>
<p/><p/><p/>
<div>
<textarea style="overflow:scroll; width: 100%; height: 250px; padding: 5px;" id="over">
제1조 목적

본 이용약관은 “윤식단”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
...
<p/>
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" name="chk" id="ag2">
  <label class="form-check-label" for="flexCheckChecked">
    개인정보 수집 및 이용 동의 <span id="err">(필수)</span>
  </label>
</div>
<p/>
<div>
...
<div>
<textarea style="overflow:hidden; width: 100%; height: 90px; padding: 5px;" id="over">
...
<div class="form-check">
  ...
  <label class="form-check-label" for="flexCheckChecked">
    SMS 수신 동의 <span id="err2">(선택)</span>
  </label>
</div>
<p/>
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" name="chk">
  <label class="form-check-label" for="flexCheckChecked">
    E-Mail 수신 동의 <span id="err2">(선택)</span>
  </label>
</div>
<p/><br/><p/>
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" name="chk" id="ag3">
  <label class="form-check-label" for="flexCheckChecked">
    만 14세 이상입니다. <span id="err">(필수)</span>
  </label>
</div>
<p/><p/><p/><p/><p/>
...
<button type="button" onclick="joinform_check();" class="btn btn-outline btn-secondary">가입하기</button>
</div>
</div>
