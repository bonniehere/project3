		...
		<div class="row justify-content-center">
			...
			<div class="col col-md-9">
					...
					<h2 class="mt-5 text-start" id="join" style="opacity: 0.5">주문 현황</h2><br>
			          ...
			          <a id="a"  id="a" href="orderList1.do">주문상태별 정렬</a><a id="a"  id="a" href="orderList2.do">배송위치별 정렬</a><a id="a"  id="a" href="orderList3.do" style=" background-color: #007bff; color: #fff;">출고담당자별(코드) 정렬</a><a id="a"  href="orderList4.do">출하담당자별 정렬</a>
			...
			<ul class="pagination pagination-lg justify-content-center">
				...
				<c:if test="${pb.startPage > pb.pagePerBlock }">
					<li class="page-item"><a id="a"  id="a"  href="orderList3.do?pageNum=1"
							class="page-link"><span aria-current="page"></span></a></li>
					<li class="page-item"><a id="a"  href="orderList3.do?pageNum=${pb.startPage - 1 }"
						class="page-link"><span aria-current="page"></span></a></li>
				</c:if>
				<c:forEach var="i" begin="${pb.startPage }" end="${pb.endPage }">
					<!-- 현재 머물고 있는 페이지가 몇 페이지인지 구별할 때 -->
					<c:if test="${pb.currentPage == i }">
						<li class="page-item"><a id="a"  href="orderList3.do?pageNum=${i }"
				...
				<c:if test="${pb.endPage < pb.totalPage }">
					<li class="page-item"><a id="a"  href="orderList3.do?pageNum=${pb.endPage + 1 }"
						class="page-link"><span aria-current="page"></span>
					</a></li>
					<li class="page-item"><a id="a"  href="orderList3.do?pageNum=${pb.totalPage }"
						class="page-link"><span aria-current="page"></span>
					</a></li>
				</c:if>
			</ul>
