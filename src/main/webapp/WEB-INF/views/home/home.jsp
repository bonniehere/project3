	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(todayA<20713){
				...
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230201gm.jpg");
			}else if(todayA<21413){
				//2023.02.17 13pm ~ 2023.02.14 13pm [최현진교수]
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230207gm.jpg");
			}else if(todayA<22113){
				//2023.02.14 13pm ~ 2023.02.21 13pm [조준환교수]
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230214_gm.jpg");
			}else if(todayA<22813){
				//2023.02.21 13pm ~ 2023.02.28 13pm [이안복교수]
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230221gm.jpg");
			}else if(todayA<30713){
				//2023.02.28 13pm ~ 2023.03.07 13pm [이상엽,하삼열교수]
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230307gm.jpg");
			}else if(todayA<31413){
				//2023.03.07 13pm ~ 2023.03.14 13pm [황지웅교수]
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230314gm.jpg");
			}else if(todayA<32113){
				//2023.03.14 13pm ~ 2023.03.21 13pm [조은정,한우식교수]
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230321_gm.jpg");
			}else if(todayA<32813){
				//2023.03.21 13pm ~ 2023.03.28 13pm [하헌균교수]
				$("#topPop").show();
				$("#popId").attr("src", "/common/front/home/images/popup/img_pop_230328gm.jpg");
...
<form id="frm" name="frm" method="POST">
	...
	<input type="hidden" id="nowDate" name="nowDate" value="20240102">
	...
	function fn_CallbackSNSFail(json){
		...
		return false;
							...
							<div class="login_box_wrap" style="position:relative;">
								...
								<h2 class="tit">로그인</h2>
								<div class="sns_wrap" style="position:absolute; top:30px; right:0; width:190px;">
									<!-- 
									<ul class="sns_list fix">
										<li class="sns_naver"><a href="javascript:void(0);" onclick="javascript:fn_LoginNaver();"><em class="skip">네이버로그인</em></a></li>
										<li class="sns_kakao"><a href="javascript:void(0);" onclick="javascript:fn_LoginKakao();"><em class="skip">카카오로그인</em></a></li>
										<li id="googleLoginBtn"><div class="S9gUrf-YoZ4jf" style="position: relative;"><div></div><iframe src="https://accounts.google.com/gsi/button?type=icon&amp;theme=outline&amp;size=large&amp;shape=circle&amp;client_id=603607955702-jjb1jhi57m612u613tg422ds0bvmmsu3.apps.googleusercontent.com&amp;iframe_id=gsi_534168_127162&amp;as=lTRWKFaDK6EMwfw4oWh55g" id="gsi_534168_127162" title="Google 계정으로 로그인 버튼" style="display: block; position: relative; top: 0px; left: 0px; height: 44px; width: 64px; border: 0px; margin: -2px -12px;"></iframe></div></li>
									</ul>
									 -->
								</div>
                        ...
                        <div class="lft_con">
                            <div class="tab_wrap">
                                <ul class="" id="board_name">
                                	<li class="on"><a href="javascript:void(0);"><span>미디어</span></a></li>
                                	<li class=""><a href="javascript:void(0);"><span>공지사항</span></a></li>
                            ...
                            <div class="tab_content">
								<div id="info1_area1" class="info_area">
									<!-- [S]미디어  -->
                                    <ul class="notice_list" id="notice_list_0" style="display: block;">
                                    	
											<li class="sty3">
												<a href="https://www.sisajournal.com/news/articleView.html?idxno=279152" target="_blank">
													<span class="tit">생소하지만 의외로 흔한 담도암</span>
													...
													<span class="info">
                                          				<em class="date">2024-01-25</em>
                                          				
                                             				
                                                				<em class="press">시사저널</em>
											...
											<li class="sty3">
												<a href="http://www.bosa.co.kr/news/articleView.html?idxno=2213537" target="_blank">
													<span class="tit">중앙대광명병원 최선영 교수, 피부과학연구재단-아모레퍼시픽 연구비 수주</span>
													 
													<span class="ssum">
														
															
															
																<img src="/_upload/profImg/11147c6d-603c-455b-b726-0ce3a7d85c49" alt="의료진 이미지">
													...
													<span class="info">
                                          				<em class="date">2023-12-28</em>
                                          				
                                             				
                                                				<em class="press">의학신문</em>
                                                				<em class="press" style="margin-left:10px;"></em>
											...
											<li class="sty3">
												<a href="https://sports.khan.co.kr/bizlife/sk_index.html?art_id=202312271117003&amp;sec_id=561801&amp;pt=nv" target="_blank">
													<span class="tit">중앙대광명병원, 응급의료기관평가 최우수 A등급</span>
													...
													<span class="info">
                                          				<em class="date">2023-12-27</em>
                                          				
                                             				
                                                				<em class="press">스포츠경향</em>
                                                				<em class="press" style="margin-left:10px;"></em>
											...
											<li class="sty3">
												<a href="https://www.dailymedi.com/news/news_view.php?wr_id=906481" target="_blank">
													<span class="tit">﻿과잉진료 방지 '현명한 선택'…참여학회 '확대' 추세</span>
													 
													<span class="ssum">
														
															
															
																<img src="/_upload/profImg/074bca3a-732a-4491-88a1-fb0a8c133495" alt="의료진 이미지">
									...
									<!-- //[E]미디어  -->
									<!-- [S]공지사항  -->
                                    <ul class="notice_list" id="notice_list_1" style="display: none;">
                                    	
                                    		<li class="sty1">
	                                    		<a href="javascript:void(0);" onclick="javascript:fn_Detail('201000000','','2','1410');">
	                                    			<span class="tit">㈜청룡환경 윤정섭 대표,  중앙대광명병원 발전기금 1억원 후원(누적 2억원)</span>
	                                    			<span class="dec">㈜청룡환경 윤정섭 대표(중앙대 사회복지학과 동문, 구로구 소재)가 지난해에 이어 중앙대학교광명병원 발전을 위해 1억원을 후원하며 지금까지 총 2억원의 발전기금을 후원했다. 윤정섭 대표는 “대학원에서 환경공학을 전공했고, 창업 때부터 여러 가지 환경사업을 시행해 지금에까지 이르렀다. 한 우물을 파는 것이 경쟁력에서 월등하고 환경사업이야말로 이 사회에서 가장 필요한 일이라고 생각한다. 이타적으로 사는 것이 나라를 위하는 것이라 생각하니 자연스럽게 사회복지 활동에 관심이 간다”또, “중앙대광명병원에서 진료를 보면서 교직원들의 친절함에 기부를 결정하게 되었다”라며 후원 소감을 밝혔다.</span>
	                                    			
	                                    				<span class="photo"><img src="/_upload/board_2/4cf8c52d-f9d8-4908-84d9-f809aaa1035a" alt="이미지"></span>
							...
							<div class="btn_main_more">
								<a href="/home/board/all/all/newsBoard4List.do" class="btn0" style="display: block;">미디어 바로가기</a>
								<a href="/home/board/2_List.do" class="btn1" style="display: none;">공지사항 바로가기</a>
                ...
                <div class="main_info_wrap">
					...
					<div class="info_card_wrap swiper-container swiper-container-initialized swiper-container-horizontal">
						<ul class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
									...
									<li class="swiper-slide swiper-slide-active" style="width: 348.5px; margin-right: 13px;">
										<div class="card_box">
											
											
												
												
													<a href="https://youtu.be/7OOxYGkApXI?si=LaFbneowgjMyay1Z" class="" target="_blank">
												
											
												
													
													<p class="photo"><img src="/_upload/board_49/c940974a-dfcd-4dac-be9e-b4e882c28bc7" alt="이미지" style="width: 270px; height: 152px;"></p>
												
												
												
												<p class="tit">기흉, 건강한 사람에게도 찾아오는 불청객</p>
												<p class="dec"></p>
											</a>
											<p class="chip_wrap">
									...
									<li class="swiper-slide swiper-slide-next" style="width: 348.5px; margin-right: 13px;">
										<div class="card_box">
											
											
												
												
													<a href="https://www.youtube.com/live/lcBE9Th_w8w?si=5CXRtPXqMTBEIOnx" class="" target="_blank">
												
											
												
													
													<p class="photo"><img src="/_upload/board_49/794f0b44-46d0-425e-a613-22ac1a52f90f" alt="이미지" style="width: 270px; height: 152px;"></p>
												
												
												
												<p class="tit">고령화시대 신체장애인을 위한 미래 로봇기술</p>
												<p class="dec"></p>
											</a>
											<p class="chip_wrap">
									...
									<li class="swiper-slide" style="width: 348.5px; margin-right: 13px;">
										<div class="card_box">
											
											
												
												
													<a href="https://vod.kbs.co.kr/index.html?source=episode&amp;sname=vod&amp;stype=vod&amp;program_code=T2000-0038&amp;program_id=PS-2023225899-01-000&amp;broadcast_complete_yn=N&amp;local_station_code=00&amp;section_code=05&amp;section_sub_code=03" class="" target="_blank">
												
											
												
													
													<p class="photo"><img src="/_upload/board_49/189d1eb5-970f-4876-8fec-44625a4c185b" alt="이미지" style="width: 270px; height: 152px;"></p>
												
												
												
												<p class="tit">지긋지긋한 통증 스트레칭으로 잡아라</p>
												<p class="dec"></p>
											</a>
											<p class="chip_wrap">
						...
						<div class="swiper-scrollbar"><div class="swiper-scrollbar-drag" style="transform: translate3d(0px, 0px, 0px); width: 171.643px;"></div></div>
					<span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                </div>
                <!-- // 건강정보 -->
            </div>
		            ...
		            <div class="inner">
		                <div class="footer_bott">
							...
							<ul class="sns_wrap fix">
								...
								<li><a href="https://instagram.com/ghcauhs_official?igshid=MzMyNGUyNmU2YQ==" target="_blank" title="새창으로 열기" class=""><img src="../../resources/img/icon/ico_circle_insta.png" alt="인스타"></a></li>
