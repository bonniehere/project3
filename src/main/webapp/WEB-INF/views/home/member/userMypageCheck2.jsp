		...
		function fn_CheckAuth(){
			...
			*/
	        ...
	        if( $("#selProfNo").val() == "" ){
	            ...
	            if( $("#selProfNo").val().length != 3 ){
	                alert("올바른 사번을 입력해주세요.");
	                $("#selProfNo").focus();
	                return false;
	            }
	        }
	        $("#frm").attr("action","/home/member/userMypage2.do");
...
<li class=""><a href="javascript:fn_goMenu('/home/member/complainList.do');">고객의소리</a></li>
	...
	<form id="frm" name="frm" method="POST" action="/home/member/userMypage2.do" target="_self">
										...
										<tbody>
														...
														<tr>
															...
															<!-- 
															 ...
															 -->
															 <input type="text" class="input_text" id="userId" name="userId" style="max-width:200px" maxlength="6" onkeyup="G_Util.inputNumber(this);" placeholder="유저 ID">
																의료진 사번 <input type="text" class="input_text" id="selProfNo" name="selProfNo" style="max-width:200px" maxlength="7" placeholder="의료진 사번">
															</td>
														</tr>
