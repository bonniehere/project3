...
<a href="javascript:fn_goMenu('/home/member/findId.do');" class="title_next">Next</a>
	...
	<section id="contents" class="contents_wrap">
		<div class="inner">
			...
			<div class="complete_box_wrap">
				<div class="complete_inner">
					<div class="complete_tit">
						<p class="">
							<em class="dec">WELCOME TO CHUNG-ANG UNIVERSITY GWANGMYEONG HOSPITAL</em>
							회원가입이 완료되었습니다
						</p>
					</div>
				</div>
				<p class="con_txt">
					중앙대학교광명병원은 회원으로 회원서비스를 이용하실 수 있습니다.<span class="m_block"></span>
					중앙대학교광명병원은 회원 여러분께 꼭 필요한 정보와 문의하신 내용에 대해 신속히 답변드리며,<span class="m_block"></span>
					여러분의 건강한 삶을 만들어 나가는데 최선을 다하겠습니다.<span class="m_block"></span>
					<span class="m_color2">회원정보 변경은 로그인 후 &lt;회원정보수정&gt; 에서 하실 수 있습니다.</span>
				</p>
				<div class="btn_area">
					<a href="/home/member/login.do" class="btn_ty01_sty01"><span>로그인</span></a>
					<a href="/home.do" class="btn_ty01_sty0"><span>홈으로</span></a>
				</div>
			</div>
		</div>
	</section>
