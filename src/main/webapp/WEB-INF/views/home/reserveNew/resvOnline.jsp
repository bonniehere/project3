...
<a href="javascript:fn_goMenu('/home/conts/106001002000000.do');" class="title_next">Next</a>
	...
	<form id="frm" name="frm" method="POST">
		...
		<input type="hidden" id="refererUrl" name="refererUrl" value="/home/reserveNew/resvOnline.do">
	...
	<section id="contents" class="contents_wrap">
	    <div class="inner">
	        ...
	        <ul class="reserv_select_list">
	            <li class="sty1">
	                <a href="javascript:void(0);" class="btn_link" onclick="javascript:fn_MoveReserve('Y');"><span>바로가기</span></a>
	                <span class="tit">회원예약</span>
	            </li>
	        ...
	        <div class="notice_gray_box">
	            <p class="notice_tit">온라인예약 주의사항</p>
	            <div class="con_txt">온라인 예약은 최소 익일부터 가능합니다. 당일진료는 해당 진료과로 문의하시기 바랍니다.<em class="m_block"></em> 회원 및 비회원 모두 예약이 가능하며 대리예약은 환자 정보 추가 입력 후 예약을 이용하실 수 있습니다.
	            <em class="m_block"></em><p style="color: red;">동일 진료과 예약을 변경하실 경우, 홈페이지에서 기존 예약을 취소 후 재 예약하시거나 중앙대학교광명병원 콜센터(1811-7800)로 전화하여 변경하시기 바랍니다.</p></div>
	        </div>
	    </div>
	</section>
